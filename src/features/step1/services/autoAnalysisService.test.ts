    ...
    describe('參數驗證錯誤', () => {
      it('應該在缺少 token 時拋出認證錯誤', async () => {
        ...
        await assertThrowsError(
          ...
          {
            correlationIdPattern: UUID_V4_PATTERN,  // 使用 UUID 格式
      ...
      it('應該在資料為空時拋出資料不足錯誤', async () => {
        ...
        await assertThrowsError(
          ...
          {
            correlationIdPattern: UUID_V4_PATTERN,  // CommonErrors 使用 UUID
            ignoreExtraFields: true
          }
        );
    ...
    describe('API 回應錯誤處理', () => {
      it('應該處理 API 返回 success: false 的情況', async () => {
        ...
        await assertThrowsError(
          ...
          {
            correlationIdPattern: TIMESTAMP_CORRELATION_PATTERN,  // createError 使用時間戳
            ignoreExtraFields: true
          }
        );
