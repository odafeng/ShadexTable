    ...
    const runAnalysis = useCallback(async () => {
        ...
        try {
            ...
            const requestBody: AnalysisRequest = {
                ...
                cat_vars: catVars.length > 0 ? catVars : null,
                cont_vars: contVars.length > 0 ? contVars : null,
                fillNA: Boolean(fillNA),
                enableAI: false,
            ...
            console.log('- fillNA:', requestBody.fillNA, '(type:', typeof requestBody.fillNA, ')');
