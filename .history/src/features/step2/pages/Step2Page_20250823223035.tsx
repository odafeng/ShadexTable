...
export default function Step2Page() {
    ...
    const runAnalysis = useCallback(async () => {
        ...
        try {
            ...
            const requestBody: AnalysisRequest = {
                ...
                enableExport: null,
                enableAI: null,
                correlation_id: currentCorrelationId,  // 添加到請求體
                // 添加額外的元數據（如果需要）
        ...
        setGroupCounts, setResultTable, setcorrelation_id, correlation_id]);
    ...
    useEffect(() => {
        ...
        if (!correlation_id) {
            ...
            setcorrelation_id(newCorrelationId);
            console.log('📌 Generated new correlation ID for Step2:', newCorrelationId);
        } else {
