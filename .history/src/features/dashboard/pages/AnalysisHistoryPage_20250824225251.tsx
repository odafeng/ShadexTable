...
interface AnalysisRecord {
  ...
  fill_na: boolean;
  ai_judgement_enable: boolean;  // 新欄位
  ai_summary_enable: boolean;    // 新欄位
  ai_enabled?: boolean;           // 向後相容欄位
  ai_model: string | null;
  ai_summary: string | null;      // 注意：後端返回的是 summary，可能需要映射
  summary?: string;                // 後端欄位名稱
  analysis_details: any;
  error_code: string | null;
  error_message: string | null;
  correlation_id: string;
  points_spent?: number;           // 後端有此欄位
  download_url?: string;
}
