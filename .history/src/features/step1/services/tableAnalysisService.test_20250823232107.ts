...
describe('TableAnalysisService', () => {
  ...
  describe('analyzeTable', () => {
    describe('Success scenarios', () => {
      ...
      it('should handle fill_na option correctly', async () => {
        // Arrange
        const requestWithfill_na: TableAnalysisRequest = {
          ...validRequest,
          fill_na: true,
        };
        ...
        // Act
        const result = await service.analyzeTable(requestWithfill_na, mockToken);
