...
export default function Step2Page() {
    ...
    const handleFillMissingValues = useCallback(async () => {
        ...
        setProcessedData, updateProcessingLog, setfill_na, correlation_id, setcorrelation_id]);
    ...
    const runAnalysis = useCallback(async () => {
        ...
        try {
            ...
            console.log('🔍 開始分析 with correlation ID:', currentCorrelationId);
    ...
    }, [activeData, catVars, contVars, fill_na, getToken, groupVar,
