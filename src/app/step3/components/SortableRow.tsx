...
import type { TableRow, BinaryMapping } from "../types";
import { formatVariableName, isCategorySubItem } from "@/services/step3_dataTransformService";
...
interface SortableRowProps {
  ...
  onEditBinaryMapping: (key: string, mapping: BinaryMapping) => void;
                    ...
                    <input
                      ...
                      onKeyDown={(e) => {
                        if (e.key === 'Enter') {
                          ...
                          onEditBinaryMapping(binaryKey, newMapping);
                          setEditingCell(null);
                        } else if (e.key === 'Escape') {
                          setEditingCell(null);
                          setTempValue('');
